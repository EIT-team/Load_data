function [ Vdemod ] = ScouseTom_data_DemodSeg( Vseg,Fs,N_prt,N_elec,N_rep,varargin )
%ScouseTom_data_DemodSeg demodulates each segment
...
for iPrt=1:N_prt
    ...
    for iElec=1:N_elec
        iRep=1;
        for iRep=1:N_rep
            Vdemod(iPrt,:,iElec,iRep)=ScouseTom_data_DemodHilbert(Vseg(iPrt,:,iElec,iRep),B,A);
        end
    end
end
