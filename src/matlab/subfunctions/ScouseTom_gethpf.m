function [Filtout,TrimSamples] = ScouseTom_gethpf(n,Fc,Fs)
% [Filtout] = ScouseTom_gethpf(n,Fc,Fs)
% makes butterworth highpass filter object of specified order
%
% inputs:
% n - filter order
...
Filtout = designfilt('highpassiir', 'FilterOrder', n, ...
